...
export class DispensaService {
  ...
  constructor(
    ...
    this.unidadeDeMedida = [
      {
        id: ReceitaIngredienteUnidadeDeMedida.Copos,
      ...
      {
        id: ReceitaIngredienteUnidadeDeMedida.Fatias,
      ...
      },
      {
        ...
        name: ReceitaIngredienteUnidadeDeMedida[11],
        abbreviation: "unidades",
        code: ReceitaIngredienteUnidadeDeMedida[11],
      },
    ];
  }
